 ...
 * @brief API request: /api/1.5/upload/check
 *
...
public:
    ...
    using Resumable = ::mf::api::upload::check::v1_5::Resumable;
    using HashAlreadyInSystem = ::mf::api::upload::check::v1_5::HashAlreadyInSystem;
    using HashAlreadyInAccount = ::mf::api::upload::check::v1_5::HashAlreadyInAccount;
    using HashAlreadyInFolder = ::mf::api::upload::check::v1_5::HashAlreadyInFolder;
    using FilenameInFolder = ::mf::api::upload::check::v1_5::FilenameInFolder;
    using FileExistsWithDifferentHash = ::mf::api::upload::check::v1_5::FileExistsWithDifferentHash;
    using StorageLimitExceeded = ::mf::api::upload::check::v1_5::StorageLimitExceeded;
    using ActionOnDuplicate = ::mf::api::upload::check::v1_5::ActionOnDuplicate;
    using VersionControl = ::mf::api::upload::check::v1_5::VersionControl;
    using AllUnitsReady = ::mf::api::upload::check::v1_5::AllUnitsReady;
