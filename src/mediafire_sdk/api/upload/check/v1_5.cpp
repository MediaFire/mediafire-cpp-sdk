...
namespace v1_5 = mf::api::upload::check::v1_5;


namespace {
std::string AsString(const v1_5::Resumable & value)
{
    if (value == v1_5::Resumable::NotResumable)
        return "no";
    if (value == v1_5::Resumable::Resumable)
        return "yes";
...
const std::string api_path("/api/1.5/upload/check");
