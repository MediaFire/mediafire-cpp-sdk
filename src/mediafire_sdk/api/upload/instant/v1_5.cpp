...
namespace v1_5 = mf::api::upload::instant::v1_5;


namespace {
std::string AsString(const v1_5::ActionOnDuplicate & value)
{
    if (value == v1_5::ActionOnDuplicate::Skip)
        return "skip";
    if (value == v1_5::ActionOnDuplicate::Keep)
        return "keep";
    if (value == v1_5::ActionOnDuplicate::Replace)
        return "replace";
...
const std::string api_path("/api/1.5/upload/instant");
