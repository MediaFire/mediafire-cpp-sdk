 ...
 * @brief API request: /api/1.5/folder/create
 *
...
namespace create {
/** API path "/api/1.5/folder/create" */
namespace v1_5 {
...
public:
    ...
    using OnNameCollision = ::mf::api::folder::create::v1_5::OnNameCollision;
    using FileDrop = ::mf::api::folder::create::v1_5::FileDrop;
    using Privacy = ::mf::api::folder::create::v1_5::Privacy;
    ...
    /**
     * Optional API parameter "parent_path"
     *
     * @param parent_path Set parameter "parent_path" in API request.
     */
    void SetParentPath(std::string parent_path);
     ...
     *
     * @param rename_on_name_collision Set parameter "action_on_duplicate" in
     *                                 API request.
     */
