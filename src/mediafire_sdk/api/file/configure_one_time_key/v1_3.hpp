...
public:
    ...
    using NofifyOwnerByEmail = ::mf::api::file::configure_one_time_key::v1_3::NofifyOwnerByEmail;
    using BurnAfterUse = ::mf::api::file::configure_one_time_key::v1_3::BurnAfterUse;
