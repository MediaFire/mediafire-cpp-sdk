...
public:
    ...
    using FileType = ::mf::api::file::create::v1_2::FileType;
    using PasswordProtected = ::mf::api::file::create::v1_2::PasswordProtected;
    using Privacy = ::mf::api::file::create::v1_2::Privacy;
